...
# USE NEXT WORD TO JUMP TO NEXT ITERATION
a <- c(2, 45, 9, 12)
...
# FUNCTIONS
# BLOCK OF CODE WRITTEN ONCE, BUT CAN BE CALLED SEVERAL TIMES WITHIN CODE BASE
##############

# function_name <- function(parameters) {
#   <block of code to run when function is called>
# }
...
# READING FROM FILE
# THE readxl LIBRARY HAS TO BE INSTALLED FIRTS USING [install.packages("readxl")]
# THEN CALL THE PACKAGE USING [library(readxl)] TO USE THE PACKAGE.
# THIS IS HOW 2RD PARTY PACKAGES ARE INSTALLED AND USED IN R PROGRAMMING
